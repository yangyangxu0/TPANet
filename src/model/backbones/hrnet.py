...
model_urls = {
    ...
    'hrnetv2p_w48': "https://github.com/hsfzxjy/models.storage/releases/download/HRNet-OCR/hrnet_ade20k_4312_torch04.pth"
}
...
pretrain_file = r'/data/project/MDPT-main_0619_add_vitea-eth/pretrain_models/hrnet_ade20k_4312_torch04.pth'

def hrnetv2p_w18_s(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> HighResolutionNet:
    """
    ...
    model = HighResolutionNet(config=extra, **kwargs)
    if pretrained:
...
def hrnetv2p_w48(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> HighResolutionNet:
    """
    Constructs a HRNet architecture.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
